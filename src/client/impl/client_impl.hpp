...
public:
    ...
    void setOnPlayerListUpdate(Client::PlayerListCallback callback);
...
private:
    ...
    void handle_resolve(beast::error_code ec, tcp::resolver::results_type results);
    void handle_connect(beast::error_code ec, tcp::resolver::results_type::endpoint_type endpoint);
