...
public:
    ...
    /** 其他玩家加入 */
    UFUNCTION(BlueprintImplementableEvent, Category = "PICO Radar|Events")
    void OnOtherPlayerJoined(const FString& PlayerId, const FPICORadarPlayerData& PlayerData);
...
private:
    ...
    /** 处理玩家加入 */
    UFUNCTION()
    void HandlePlayerJoined(const FString& JoinedPlayerId, const FPICORadarPlayerData& PlayerData);
...
private:
    ...
    /** 创建玩家可视化 */
    class APICORadarPlayerVisualization* CreatePlayerVisualization(const FPICORadarPlayerData& PlayerData);
