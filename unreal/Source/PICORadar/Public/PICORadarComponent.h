...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPICORadarDisconnected,
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPlayerListUpdated,
                                            const TArray<FPICORadarPlayerData>&,
                                            Players);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FOnPlayerJoined, const FString&,
                                             PlayerId,
                                             const FPICORadarPlayerData&,
                                             PlayerData);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPlayerLeft, const FString&,
                                            PlayerId);
...
class PICORADAR_API UPICORadarComponent : public UActorComponent,
 ...
 public:
  ...
  void ConnectToServer(const FString& ServerAddress, const FString& PlayerId,
   ...
   */
  UFUNCTION(BlueprintPure, Category = "PICO Radar")
  bool GetPlayerData(const FString& PlayerId,
 ...
 private:
  ...
  /** 转换UE坐标到PICORadar坐标系 */
  FPICORadarPlayerData CreatePlayerDataFromTransform(
...
class PICORADAR_API FPICORadarConnectionTask {
 public:
  ...
  /** 开始连接 */
  void StartConnection(const FString& ServerAddress, const FString& PlayerId,
                       const FString& AuthToken);
